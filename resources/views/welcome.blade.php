...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	@if (!empty($homeSliders) && $homeSliders->count())
                    ...
                    <div class="container">
                        <div class="row d-flex no-gutters slider-text align-items-end justify-content-end"
                            ...
                            <div class="one-third js-fullheight order-md-last img"
                                style="background-image:url({{ str_replace('\\', '/', $slider->image) }});">
                                <div class="overlay"></div>
                            </div>
                            <div class="one-forth d-flex align-items-center ftco-animate"
                                ...
                                <div class="text">
                                    ...
                                    <p><a href="#contact-section" class="btn btn-primary py-3 px-4">Hire me</a> <a href="#projects-section"
                    ...
                    <div class="col-md-6 col-lg-5 d-flex">
                        <div class="img-about img d-flex align-items-stretch">
                            ...
                            <div class="img d-flex align-self-stretch align-items-center"
                                style="background-image:url({{ str_replace('\\', '/', $about->image) }});">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <p>"Kindness is a language that the deaf can hear and the blind can see." - Mark Twain
                                </p>
                                <ul class="about-info mt-4 px-md-0 px-2">
                                    <li class="d-flex"><span>Name:</span> <span>{{ $about->name }}</span></li>
                                    <li class="d-flex"><span>Date of birth:</span> <span>{{ $about->dob }}</span>
                                    </li>
                        ...
                        <div class="counter-wrap ftco-animate d-flex mt-md-3">
                            <div class="text">
                                ...
                                <p><a href="https://drive.google.com/file/d/1PdSUleR3_l6oCrr-bUVbkEbDXwo-mqYA/view?usp=sharing" class="btn btn-primary py-3 px-3">Download CV</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
				...
				align-items: stretch;" class="col-md-6">
                            <div style="flex: 1;" class="resume-wrap ftco-animate">
                                <span
                                    class="date">{{ date('Y', strtotime($resume->starting)) }}-{{ date('Y', strtotime($resume->ending)) }}</span>
                                <h2>{{ $resume->degree_name }}</h2>
                                <a href="{{ $resume->institute_src }}"> <span
                                        class="position">{{ $resume->institute }}</span> </a>
            ...
            <div class="container">
                <div class="row justify-content-center py-5 mt-5">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>"The best way to find yourself is to lose yourself in the service of others." - Mahatma
                            Gandhi</p>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    ...
                    <p>"Skills are the currency of the future. Continuously invest in learning and honing your skills to
                        stay relevant in an ever-evolving world."</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    ...
                    <p>"Projects are the bridge between ideas and reality. They showcase not only what you create, but
                        your ability to innovate, collaborate, and bring concepts to life."</p>
                </div>
            </div>
            <div class="row">
                @for ($i = 0; $i < count($projects); $i++)
                    <div class="col-md-6">
                        <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                            style="background-image: url({{ str_replace('\\', '/', $projects[$i]->image) }});">
                            <div class="overlay"></div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-5">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    ...
                    <p>"Blogs are a canvas of thoughts, a platform to share insights, and a doorway to engage with a
                        wider world. Each post is a brushstroke of knowledge painted on the canvas of the digital
                        realm."</p>
                </div>
            </div>
            <div class="row d-flex">
                @foreach ($blogs as $blog)
                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry justify-content-end">
                            <a href="{{ route('blog', ['id' => $blog->id]) }}" class="block-20"
                                style="background-image: url({{ str_replace('\\', '/', $blog->image) }});">
                            </a>
                            <div class="text mt-3 float-right d-block">
                                ...
                                <h3 class="heading"><a
                                        href="{{ route('blog', ['id' => $blog->id]) }}">{{ $blog->title }}</a></h3>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    ...
                    <p>"Let's connect and build bridges of communication. Reach out, and let's collaborate to turn ideas
                        into reality."</p>
                </div>
            </div>
            ...
            <div class="row no-gutters block-9">
                ...
                <div class="col-md-6 d-flex">
                    <div class="img" style="background-image: url({{ str_replace('\\', '/', $about->image) }});">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="list-unstyled">
                            @if(!empty($services) && $services->count())
							@foreach ($services as $service)
							<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>{{ $service->name }}</a>
                            </li>
							@endforeach
							@endif
                        </ul>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span
                                        class="text">{{ $about->address }}</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span
                                            class="text">{{ $about->phone }}</span></a></li>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        </script> All rights reserved by authority
