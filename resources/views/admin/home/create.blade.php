                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:">Add Slider</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                            ...
                                            <form action="{{ route('homes.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="intro" class="form-control" id="exampleInputEmail1"
                                                        aria-describedby="emailHelp" placeholder="Enter intro" value="{{ old('intro') }}" required>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <img id="output" style="margin-top: 5%" src="" width="50%" height="80%">
                                        </div>
                                    </div>
                                </div>
                            </div>
