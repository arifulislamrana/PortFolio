...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="/themes/admin/assets//images/favicon.ico" type="image/x-icon">
    <!-- fontawesome icon -->
    <link rel="stylesheet" href="/themes/admin/assets//fonts/fontawesome/css/fontawesome-all.min.css">
    <!-- animation css -->
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('abouts.index') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">About</span></a>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{ route('services.index') }}" class="">Service</a></li>
                            <li class=""><a href="{{ route('services.create') }}" class="">Add new</a></li>
                        </ul>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Skills</span></a>
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{ route('skills.index') }}" class="">Skills</a></li>
                            <li class=""><a href="{{ route('skills.create') }}" class="">Add new</a></li>
                        </ul>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Project</span></a>
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{ route('projects.index') }}" class="">Projects</a></li>
                            <li class=""><a href="{{ route('projects.create') }}" class="">Add new</a></li>
                        </ul>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Blog</span></a>
                        <ul class="pcoded-submenu">
                            <li class=""><a href="{{ route('blogs.index') }}" class="">Blogs</a></li>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/themes/admin/assets//images/user/avatar-1.jpg" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/themes/admin/assets//images/user/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/themes/admin/assets//images/user/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
