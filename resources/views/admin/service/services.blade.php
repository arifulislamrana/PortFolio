                ...
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('services.create') }}"><button type="button" class="btn btn-primary float-right">Add New</button></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Services</h5>
                                    <form style="float: right" method="GET" action="{{ route('services.index') }}" id="search-form" class="form-inline my-2 my-lg-0">
                                ...
                                <div class="card-block table-border-style">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$services[$i]->icon}}</td>
                                                    <td>
                                                        <a class="btn btn-rounded btn-primary" href="#">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a class="btn btn-rounded btn-info" href="{{ route('services.edit', ['service' => $services[$i]->id]) }}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a class="btn btn-rounded btn-danger" onclick="showModal({{$services[$i]->id}})" data-toggle="modal" href="#">
                                        ...
                                        @else
                                            <h4 style="text-align: center">No services Exists</h4>
                                        @endif
                                    </div>
                                </div>
                            </div>
